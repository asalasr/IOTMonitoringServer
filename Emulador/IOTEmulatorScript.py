...
'''
MQTT_HOST = "54.85.198.201"  # "ip.maquina.mqtt"
MQTT_PORT = 8082

'''
Usuario y contraseña para la conexión MQTT
'''
MQTT_USER = "admin"  # "pe.perez"
MQTT_PASSWORD = "admin"  # "abc123"
...
def process_message(msg: str):
    ...
    if ("Cierre de Sistema" in msg):
        p = vlc.MediaPlayer("/Volumes/HDAndresS/Documentos_Andres/UNIANDES/Miso/IV_Semestre/Ciclo_VII/IoT/Alerta.mp3")
        p.play()
